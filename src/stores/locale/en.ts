...
*/
  ...
  'tool.html.description':
    'Encoder or decoder all the applicable characters to their corresponding HTML',

  'tool.url.title': 'URL Encoder / Decoder',
  'tool.url.mintitle': 'URL',
  'tool.url.description':
    'Encoder or decode all the applicable characters to their corresponding URL',
  ...
  'tool.hashgen.description':
    'Calculate MD5, SHA1, SHA256 and SHA 512 hash from text data',
  ...
  'tool.textinspect.description':
    'Analyze text and convert it to different case',
  Charactors: 'Characters',
  Lines: 'Lines',
  Bytes: 'Bytes',
  UpperCaseInspect: 'UpperCase',

  'tool.escape.title': 'Text Escape / UnEscape',
  'tool.escape.mintitle': 'Text Escape',
  ...
  'Picker the color and copy components':
    'Pick a color and copy the formatted color',
  'HSB Box': 'HSB Box',
  ...
  'The width of the Gif file':
    'The width of the Gif file (height will be determined)',
  FPS: 'FPS',
  'FPS of the Gif file to be exported': 'FPS of the Gif file to be exported',
  'Remove source file': 'Remove source file',
  'Whether to delete the source file after exporting a Gif':
    'Whether to delete the source file after exporting a Gif',

  'Audio Converter': 'Audio Converter',
  'Convert audio from one format to another':
    'Convert audio from one format to another',
  'Whether to delete the source file after exporting a Audio':
    'Whether to delete the source file after exporting a Audio',
  'Starting...': 'Starting...',
  Complete: 'Complete',
