...
const { t } = language
const fonts = ['Arial', 'Helvetica', 'sans-serif', 'Arial Black', 'Gadget', 'Bookman Old Style', 'serif', 'Comic Sans MS', 'cursive', 'Courier', 'monospace', 'Courier New', 'Garamond', 'Georgia', 'Impact', 'Charcoal', 'Lucida Console', 'Monaco', 'Lucida Sans Unicode', 'Lucida Grande', 'MS Sans Serif', 'Geneva', 'MS Serif', 'New York', 'Palatino Linotype', 'Book Antiqua', 'Palatino', 'Symbol', 'Tahoma', 'Times New Roman', 'Times', 'Trebuchet MS', 'Verdana', 'Webdings', 'Wingdings', 'Zapf Dingbats']
...
<template>
  <div class="dev-toys-settings">
    <SettingCard :title="t('App Theme')" :desc="t('Choose your preferred theme to change the look and feel of the interface.')">
      ...
      <el-select :model-value="settings.appTheme" size="small" @change="settings.appThemeChange">
    ...
    <SettingCard :title="t('Language')" :desc="t('Choose the language you want to use.')">
      <template #icon>
        <IconLanguage />
      </template>
      <el-select :model-value="language.locale" size="small" @change="language.changeLanguage">
